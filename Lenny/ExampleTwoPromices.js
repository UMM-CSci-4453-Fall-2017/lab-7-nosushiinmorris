...
var processDBF = function(queryResults) {
...
var processTables = function(results) {
    ...
    var allTables = Promise.all(descriptionPromises).then(function(results) {
        return(results);
    });
    return (allTables);
}
...
var dbfToPromise = function(dbfObj) {
    ...
    queryPromise = queryPromise.then(function(results) {
...
var tableAndDbfToPromise = function(obj) {
    ...
    var tables = tableObj.map(function(val) {
        return(val[key]);
    });
